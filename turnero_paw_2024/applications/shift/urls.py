...
urlpatterns = [
    ...
    path('initiate_cancel_shift/', views.initiate_cancel_shift, name='initiate_cancel_shift'),
    path('confirm_cancel_shift/<int:shift_id>/', views.confirm_cancel_shift, name='confirm_cancel_shift'),
