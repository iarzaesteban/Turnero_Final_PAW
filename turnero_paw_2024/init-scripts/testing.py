...
data = [
    {"model": "aditional_information.AditionalInformation", "pk": 1, "fields": {"short_description": "contacto", "title": "Contacto", "description": "¿Necesitas ayuda? ¡No dudes en contactarnos! Estamos aquí para responder a tus preguntas y brindarte el mejor servicio posible.", "icon": "contacto"}},
    ...
    {"model": "aditional_information.AditionalInformation", "pk": 3, "fields": {"short_description": "ubicacion", "title": "Ubicación", "description": "Encuéntranos en el campus universitario. Nuestra oficina de enrolamiento está ubicada en [Ubicación específica]. Visítanos para obtener asistencia personalizada.", "icon": "ubicacion"}}
]
